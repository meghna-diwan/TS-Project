...
# Assigning forecasted value based on proportions and total sales
for (i in 2:47){
  for (j in 1:1679){
    train.proportion[j,i] <- result_pro$yhat[j]*train.proportion[j,i]
  }
}

# smape for each column will be the same as the total
```
